...
whowishWordDialogHelper.createDialog = function() {
	...
	$w('body').append('<div class="whowishWordDialog" id="whowishWordDialog">' +
		...
		'<span class="buttonPanel">' +
		 	'<span id="whowishWordDialogSaveButton" class="btn btn-success saveButton">Save</span>' +
			'<span id="whowishWordDialogCloseButton" class="btn btn-failure closeButton">Close</span>' +
		'</span>' +
	'</div>');
